...
/**
 * Per-glyph metric data for the 14 standard PDF fonts (Core 14).
 *
 * Generated from URW Base35 AFM files (metric-compatible substitutes
 * for the Adobe Core 14, license: AFPL/GPL — but we ship no font
 * data, only width *numbers*, which are facts).
 *
 * Each entry exposes:
 *  - 'widths'    : 256 ints — width per WinAnsi byte code (1000em units)
 *  - 'default'   : fallback width (.notdef)
 *  - 'ascender'  : top of the highest glyph above baseline (1000em)
 *  - 'descender' : bottom of the lowest glyph below baseline (negative)
 *  - 'capHeight' : top of capital letters (e.g. 'H')
 *
 * Regenerate with:
 *   php tools/build-afm-widths.php
 */
final class Core14Widths
{
    /** @var array<string, array{widths: int[], default: int, ascender: int, descender: int, capHeight: int}> */
    public const FONTS = [
        'Helvetica' => [
            'widths' => [
        ...
        'Helvetica-Bold' => [
            'widths' => [
             ...
             278, 278, 278, 500, 500, 350, 556,1000, 333,1000, 556, 333, 944, 278, 500, 667,
        ...
        'Times-Roman' => [
            'widths' => [
             ...
             500, 250, 333, 500, 444,1000, 500, 500, 333,1000, 556, 333, 889, 250, 611, 250,
             250, 333, 333, 444, 444, 350, 500,1000, 333, 980, 389, 333, 722, 250, 444, 722,
        ...
        'Times-Bold' => [
            'widths' => [
             ...
             500, 250, 333, 500, 500,1000, 500, 500, 333,1000, 556, 333,1000, 250, 667, 250,
             250, 333, 333, 500, 500, 350, 500,1000, 333,1000, 389, 333, 722, 250, 444, 722,
        ...
        'Times-Italic' => [
            'widths' => [
             ...
             500, 250, 333, 500, 556, 889, 500, 500, 333,1000, 500, 333, 944, 250, 556, 250,
             250, 333, 333, 556, 556, 350, 500, 889, 333, 980, 389, 333, 667, 250, 389, 556,
        ...
        'Times-BoldItalic' => [
            'widths' => [
             ...
             500, 250, 333, 500, 500,1000, 500, 500, 333,1000, 556, 333, 944, 250, 611, 250,
             250, 333, 333, 500, 500, 350, 500,1000, 333,1000, 389, 333, 722, 250, 389, 611,
        ...
        'Symbol' => [
            'widths' => [
             ...
             750, 250, 250, 500, 250,1000, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 460, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 713, 250, 250, 250,
             400, 549, 250, 250, 250, 576, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 250, 250, 549, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250,
             250, 250, 250, 250, 250, 250, 250, 549, 250, 250, 250, 250, 250, 250, 250, 250
            ],
            'default'   => 250,
