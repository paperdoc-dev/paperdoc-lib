...
### Added
- Initial `README.md`, `CONTRIBUTING.md`, `CHANGELOG.md`, `CODEOWNERS`
- `.github/release.yml` and `.github/FUNDING.yml` for GitHub automation
...
- **Renderers**: PDF, HTML, DOCX, XLSX, PPTX, CSV, Markdown
