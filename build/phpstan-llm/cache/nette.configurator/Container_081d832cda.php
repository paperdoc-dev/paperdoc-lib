...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm.neon
// source: array
...
class Container_081d832cda extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm.neon',
			],
			null,
			[
	...
	public function createService0126(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/home/akramzerarka/Projects/paperdoc/paperdoc-lib',
			'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm',
			[
				'phar:///home/akramzerarka/Projects/paperdoc/paperdoc-lib/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm.neon',
			],
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm/resultCache.php');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_081d832cda $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm/resultCache.php',
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm/cache/PHPStan');
	}


	public function createServiceContainer(): Container_081d832cda
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Llm'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm/resultCache.php',
			...
			'tmpDir' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-llm',
