...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers.neon
// source: array
...
class Container_66857308a3 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers.neon',
			],
			null,
			[
	...
	public function createService0126(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/home/akramzerarka/Projects/paperdoc/paperdoc-lib',
			'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers',
			[
				'phar:///home/akramzerarka/Projects/paperdoc/paperdoc-lib/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers.neon',
			],
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers/resultCache.php');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_66857308a3 $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers/resultCache.php',
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers/cache/PHPStan');
	}


	public function createServiceContainer(): Container_66857308a3
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Parsers'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers/resultCache.php',
			...
			'tmpDir' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-parsers',
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:43493\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:43493\'; builtin export http_proxy=\'http://127.0.0.1:43493\'; builtin export https_proxy=\'http://127.0.0.1:43493\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:43493\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:43493\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:43569\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:43569\'; builtin export socks_proxy=\'socks5://127.0.0.1:43569\'; builtin export socks5_proxy=\'socks5://127.0.0.1:43569\'; builtin export ALL_PROXY=\'http://127.0.0.1:43493\'; builtin export all_proxy=\'http://127.0.0.1:43493\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:43569',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:43493',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:43493',
				...
				'CURSOR_CONVERSATION_ID' => '6aba4a3d-1bd8-4f85-9747-f7053ee44516',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:43493',
				...
				'socks_proxy' => 'socks5://127.0.0.1:43569',
				...
				'SHLVL' => '1',
				'HTTPS_PROXY' => 'http://127.0.0.1:43493',
				'HTTP_PROXY' => 'http://127.0.0.1:43493',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:43493',
