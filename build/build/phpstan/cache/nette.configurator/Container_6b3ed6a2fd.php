...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-renderers.neon
// source: array
...
class Container_6b3ed6a2fd extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-renderers.neon',
			],
			null,
			[
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_6b3ed6a2fd $container)
			{
	...
	public function createServiceContainer(): Container_6b3ed6a2fd
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/src/Renderers'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:42813\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:42813\'; builtin export http_proxy=\'http://127.0.0.1:42813\'; builtin export https_proxy=\'http://127.0.0.1:42813\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:42813\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:42813\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:37551\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:37551\'; builtin export socks_proxy=\'socks5://127.0.0.1:37551\'; builtin export socks5_proxy=\'socks5://127.0.0.1:37551\'; builtin export ALL_PROXY=\'http://127.0.0.1:42813\'; builtin export all_proxy=\'http://127.0.0.1:42813\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:37551',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:42813',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:42813',
				...
				'CURSOR_CONVERSATION_ID' => '459e9646-a613-47a8-b26d-e57eed16dfa5',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:42813',
				...
				'socks_proxy' => 'socks5://127.0.0.1:37551',
				...
				'HTTPS_PROXY' => 'http://127.0.0.1:42813',
				'HTTP_PROXY' => 'http://127.0.0.1:42813',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:42813',
