...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-docx.neon
// source: array
...
class Container_bd47355293 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-docx.neon',
			],
			null,
			[
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_bd47355293 $container)
			{
	...
	public function createServiceContainer(): Container_bd47355293
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Parsers/DocxParser.php'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:39029\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:39029\'; builtin export http_proxy=\'http://127.0.0.1:39029\'; builtin export https_proxy=\'http://127.0.0.1:39029\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:39029\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:39029\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:39603\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:39603\'; builtin export socks_proxy=\'socks5://127.0.0.1:39603\'; builtin export socks5_proxy=\'socks5://127.0.0.1:39603\'; builtin export ALL_PROXY=\'http://127.0.0.1:39029\'; builtin export all_proxy=\'http://127.0.0.1:39029\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:39603',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:39029',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:39029',
				...
				'CURSOR_CONVERSATION_ID' => 'e03b7ce1-ad43-4f78-9699-50345ee87b97',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:39029',
				...
				'socks_proxy' => 'socks5://127.0.0.1:39603',
				...
				'SHLVL' => '1',
				'HTTPS_PROXY' => 'http://127.0.0.1:39029',
				'HTTP_PROXY' => 'http://127.0.0.1:39029',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:39029',
