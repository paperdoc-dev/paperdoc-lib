...
class Container_167fe6775c extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_167fe6775c $container)
			{
	...
	public function createServiceContainer(): Container_167fe6775c
	{
		return $this;
	}
