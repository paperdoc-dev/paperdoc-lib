...
class Container_f8feee06f7 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'/home/akramzerarka/Projects/paperdoc',
			($this->getParameter('sysGetTempDir')) . '/phpstan-fixer',
			['/home/akramzerarka/Projects/paperdoc/paperdoc-lib', '/home/akramzerarka/Projects/paperdoc'],
			[
	...
	{
		return new PHPStan\File\FileHelper('/home/akramzerarka/Projects/paperdoc');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_f8feee06f7 $container)
			{
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/home/akramzerarka/Projects/paperdoc', $this->getService('06'), false);
	}
	...
	public function createServiceContainer(): Container_f8feee06f7
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/home/akramzerarka/Projects/paperdoc');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/home/akramzerarka/Projects/paperdoc');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'currentWorkingDirectory' => '/home/akramzerarka/Projects/paperdoc',
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:38151\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:38151\'; builtin export http_proxy=\'http://127.0.0.1:38151\'; builtin export https_proxy=\'http://127.0.0.1:38151\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:38151\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:38151\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:46303\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:46303\'; builtin export socks_proxy=\'socks5://127.0.0.1:46303\'; builtin export socks5_proxy=\'socks5://127.0.0.1:46303\'; builtin export ALL_PROXY=\'http://127.0.0.1:38151\'; builtin export all_proxy=\'http://127.0.0.1:38151\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:46303',
				'EDITOR' => '/usr/bin/nano',
				...
				'PWD' => '/home/akramzerarka/Projects/paperdoc',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:38151',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:38151',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:38151',
				...
				'socks_proxy' => 'socks5://127.0.0.1:46303',
				...
				'SHLVL' => '1',
				'HTTPS_PROXY' => 'http://127.0.0.1:38151',
				'HTTP_PROXY' => 'http://127.0.0.1:38151',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:38151',
				...
				'_' => './paperdoc-lib/vendor/bin/phpstan',
				'LINES' => '50',
				'COLUMNS' => '80',
				'SHELL_VERBOSITY' => '0',
			],
