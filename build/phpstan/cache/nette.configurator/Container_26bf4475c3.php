...
class Container_26bf4475c3 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0459(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				[
					'message' => '#^Parameter \#1 \$value of static method Paperdoc\\\Document\\\Metadata\:\:toDateTime\(\) expects DateTimeInterface\|string\|null, mixed given\.$#',
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_26bf4475c3 $container)
			{
	...
	public function createServiceContainer(): Container_26bf4475c3
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:41477\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:41477\'; builtin export http_proxy=\'http://127.0.0.1:41477\'; builtin export https_proxy=\'http://127.0.0.1:41477\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:41477\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:41477\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:37823\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:37823\'; builtin export socks_proxy=\'socks5://127.0.0.1:37823\'; builtin export socks5_proxy=\'socks5://127.0.0.1:37823\'; builtin export ALL_PROXY=\'http://127.0.0.1:41477\'; builtin export all_proxy=\'http://127.0.0.1:41477\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:37823',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:41477',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:41477',
				...
				'COMPOSER_DEV_MODE' => '1',
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:41477',
				...
				'socks_proxy' => 'socks5://127.0.0.1:37823',
				...
				'HTTPS_PROXY' => 'http://127.0.0.1:41477',
				'HTTP_PROXY' => 'http://127.0.0.1:41477',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:41477',
