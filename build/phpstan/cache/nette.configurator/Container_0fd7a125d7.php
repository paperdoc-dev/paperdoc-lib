...
class Container_0fd7a125d7 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_0fd7a125d7 $container)
			{
	...
	public function createServiceContainer(): Container_0fd7a125d7
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:45605\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:45605\'; builtin export http_proxy=\'http://127.0.0.1:45605\'; builtin export https_proxy=\'http://127.0.0.1:45605\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:45605\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:45605\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:41905\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:41905\'; builtin export socks_proxy=\'socks5://127.0.0.1:41905\'; builtin export socks5_proxy=\'socks5://127.0.0.1:41905\'; builtin export ALL_PROXY=\'http://127.0.0.1:45605\'; builtin export all_proxy=\'http://127.0.0.1:45605\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:41905',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:45605',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:45605',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:45605',
				...
				'socks_proxy' => 'socks5://127.0.0.1:41905',
				...
				'SHLVL' => '1',
				'HTTPS_PROXY' => 'http://127.0.0.1:45605',
				'HTTP_PROXY' => 'http://127.0.0.1:45605',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:45605',
