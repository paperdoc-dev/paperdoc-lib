...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-ocr.neon
// source: array
...
class Container_b1b4259ffe extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-ocr.neon',
			],
			null,
			[
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_b1b4259ffe $container)
			{
	...
	public function createServiceContainer(): Container_b1b4259ffe
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Ocr'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:45195\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:45195\'; builtin export http_proxy=\'http://127.0.0.1:45195\'; builtin export https_proxy=\'http://127.0.0.1:45195\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:45195\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:45195\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:39225\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:39225\'; builtin export socks_proxy=\'socks5://127.0.0.1:39225\'; builtin export socks5_proxy=\'socks5://127.0.0.1:39225\'; builtin export ALL_PROXY=\'http://127.0.0.1:45195\'; builtin export all_proxy=\'http://127.0.0.1:45195\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:39225',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:45195',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:45195',
				...
				'CURSOR_CONVERSATION_ID' => '24ca21bd-526f-4aa6-8a60-d8cd0b340e1e',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:45195',
				...
				'socks_proxy' => 'socks5://127.0.0.1:39225',
				...
				'HTTPS_PROXY' => 'http://127.0.0.1:45195',
				'HTTP_PROXY' => 'http://127.0.0.1:45195',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:45195',
