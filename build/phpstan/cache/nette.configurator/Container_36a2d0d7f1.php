...
class Container_36a2d0d7f1 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_36a2d0d7f1 $container)
			{
	...
	public function createServiceContainer(): Container_36a2d0d7f1
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Renderers'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:36237\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:36237\'; builtin export http_proxy=\'http://127.0.0.1:36237\'; builtin export https_proxy=\'http://127.0.0.1:36237\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:36237\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:36237\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:38897\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:38897\'; builtin export socks_proxy=\'socks5://127.0.0.1:38897\'; builtin export socks5_proxy=\'socks5://127.0.0.1:38897\'; builtin export ALL_PROXY=\'http://127.0.0.1:36237\'; builtin export all_proxy=\'http://127.0.0.1:36237\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:38897',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:36237',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:36237',
				...
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:36237',
				...
				'socks_proxy' => 'socks5://127.0.0.1:38897',
				...
				'HTTPS_PROXY' => 'http://127.0.0.1:36237',
				'HTTP_PROXY' => 'http://127.0.0.1:36237',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:36237',
