...
// source: /home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-rest.neon
// source: array
...
class Container_8f7e21e190 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/build/phpstan-rest.neon',
			],
			null,
			[
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_8f7e21e190 $container)
			{
	...
	public function createServiceContainer(): Container_8f7e21e190
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Ole2/Ole2Writer.php',
			],
			'exceptions' => [
				'implicitThrows' => true,
