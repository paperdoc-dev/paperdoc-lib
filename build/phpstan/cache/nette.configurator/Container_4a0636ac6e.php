...
class Container_4a0636ac6e extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0459(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					'message' => '#^Parameter \#1 \$config of static method Paperdoc\\\Llm\\\ProviderFactory\:\:make\(\) expects array\{provider\?\: string, model\?\: string, api_key\?\: string, base_url\?\: string\}, array\<string, mixed\> given\.$#',
					'identifier' => 'argument.type',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Llm/LlmAugmenter.php',
				],
				[
					'message' => '#^Property Paperdoc\\\Llm\\\LlmAugmenter\:\:\$options \(array\<string, mixed\>\) does not accept array\<mixed, mixed\>\.$#',
					'identifier' => 'assign.propertyType',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Llm/LlmAugmenter.php',
				],
				...
				[
					'message' => '#^Offset \'children\' might not exist on array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\: int\|null, children\?\: list\<int\>, prev\: int\|null, next\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'children\' might not exist on non\-empty\-array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\?\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'next\' might not exist on array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\: int\|null, children\?\: list\<int\>, prev\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'obj\' might not exist on array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\: int\|null, children\: list\<int\>, prev\: int\|null, next\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 4,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'obj\' might not exist on non\-empty\-array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\?\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 6,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'page\' might not exist on non\-empty\-array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\?\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'parent\' might not exist on non\-empty\-array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\?\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 3,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'prev\' might not exist on array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'title\' might not exist on non\-empty\-array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\?\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset \'y\' might not exist on array\{obj\?\: int, title\?\: string, page\?\: int, y\?\: float, parent\: int\|null, children\?\: list\<int\>, prev\?\: int\|null, next\?\: int\|null\}\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Offset int\<0, max\>\|null might not exist on list\<int\<0, max\>\>\.$#',
					'identifier' => 'offsetAccess.notFound',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
				[
					'message' => '#^Possibly invalid array key type int\<0, max\>\|null\.$#',
					'identifier' => 'offsetAccess.invalidOffset',
					'count' => 1,
					'path' => '/home/akramzerarka/Projects/paperdoc/paperdoc-lib/src/Support/Pdf/PdfEngine.php',
				],
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_4a0636ac6e $container)
			{
	...
	public function createServiceContainer(): Container_4a0636ac6e
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'__CURSOR_SANDBOX_ENV_RESTORE' => 'builtin export HTTP_PROXY=\'http://127.0.0.1:42575\'; builtin export HTTPS_PROXY=\'http://127.0.0.1:42575\'; builtin export http_proxy=\'http://127.0.0.1:42575\'; builtin export https_proxy=\'http://127.0.0.1:42575\'; builtin export GIT_HTTP_PROXY=\'http://127.0.0.1:42575\'; builtin export GIT_HTTPS_PROXY=\'http://127.0.0.1:42575\'; builtin export SOCKS_PROXY=\'socks5://127.0.0.1:46193\'; builtin export SOCKS5_PROXY=\'socks5://127.0.0.1:46193\'; builtin export socks_proxy=\'socks5://127.0.0.1:46193\'; builtin export socks5_proxy=\'socks5://127.0.0.1:46193\'; builtin export ALL_PROXY=\'http://127.0.0.1:42575\'; builtin export all_proxy=\'http://127.0.0.1:42575\'; builtin export NO_PROXY=\'127.0.0.1,::1,localhost\'; builtin export no_proxy=\'127.0.0.1,::1,localhost\'',
				...
				'SOCKS5_PROXY' => 'socks5://127.0.0.1:46193',
				'EDITOR' => '/usr/bin/nano',
				...
				'GIT_HTTP_PROXY' => 'http://127.0.0.1:42575',
				...
				'GIT_HTTPS_PROXY' => 'http://127.0.0.1:42575',
				...
				'COMPOSER_DEV_MODE' => '1',
				'FORCE_COLOR' => '0',
				'https_proxy' => 'http://127.0.0.1:42575',
				...
				'socks_proxy' => 'socks5://127.0.0.1:46193',
				...
				'HTTPS_PROXY' => 'http://127.0.0.1:42575',
				'HTTP_PROXY' => 'http://127.0.0.1:42575',
				'QT_IM_MODULE' => 'ibus',
				...
				'ALL_PROXY' => 'http://127.0.0.1:42575',
