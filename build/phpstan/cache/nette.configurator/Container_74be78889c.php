...
class Container_74be78889c extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_74be78889c $container)
			{
	...
	public function createServiceContainer(): Container_74be78889c
	{
		return $this;
	}
